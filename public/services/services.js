...
app.factory("Sample", function() {
  ...
  Sample.SAMPLE1 = {
    "tables":[{"name":"Mail","rows":[{"key":"12345","cqs":[{"name":"messageId","value":"5fc38314-e290-ae5da5fc375d"},{"name":"timestamp","value":"1307097848"},{"name":"email-message","value":"Hi Lars, ..."}]},{"key":"12345","cqs":[{"name":"messageId","value":"725aae5f-d72e-f90f3f070419"},{"name":"timestamp","value":"1307099848"},{"name":"email-message","value":"Welcome, and ..."}]},{"key":"12345","cqs":[{"name":"messageId","value":"cc6775b3-f249-c6dd2b1a7467"},{"name":"timestamp","value":"1307101848"},{"name":"email-message","value":"To Whom It ..."}]},{"key":"12345","cqs":[{"name":"messageId","value":"dcbee495-6d5e-6ed48124632c"},{"name":"timestamp","value":"1307103848"},{"name":"email-message","value":"Hi, how are ..."}]},{"key":"67890","cqs":[{"name":"messageId","value":"531ee495-6d5e-7e3a81248ef4"},{"name":"timestamp","value":"1484696746"},{"name":"email-message","value":"Hello World"}]}]}],"operations":[{"title":"Create 1st mail","type":0,"cqs":{"create":[{"name":"messageId","value":"5fc38314-e290-ae5da5fc375d"},{"name":"timestamp","value":"1307097848"},{"name":"email-message","value":"Hi Lars, ..."}]},"summary":"Create 1st mail, using userId treats as rowkey","table":"Mail","key":"12345"},{"title":"Create 2nd mail","type":0,"cqs":{"create":[{"name":"messageId","value":"725aae5f-d72e-f90f3f070419"},{"name":"timestamp","value":"1307099848"},{"name":"email-message","value":"Welcome, and ..."}]},"table":"Mail","key":"12345"},{"title":"Create 3rd mail","type":0,"cqs":{"create":[{"name":"messageId","value":"cc6775b3-f249-c6dd2b1a7467"},{"name":"timestamp","value":"1307101848"},{"name":"email-message","value":"To Whom It ..."}]},"table":"Mail","key":"12345"},{"title":"Create 4th mail","type":0,"cqs":{"create":[{"name":"messageId","value":"dcbee495-6d5e-6ed48124632c"},{"name":"timestamp","value":"1307103848"},{"name":"email-message","value":"Hi, how are ..."}]},"table":"Mail","key":"12345"},{"title":"Get all User[12345] mails","type":2,"cqs":["messageId","timestamp","email-message"],"summary":"Use Row Key scan all specific userId mails","table":"Mail","rows":[{"key":"12345","values":["5fc38314-e290-ae5da5fc375d","1307097848","Hi Lars, ..."]},{"key":"12345","values":["725aae5f-d72e-f90f3f070419","1307099848","Welcome, and ..."]},{"key":"12345","values":["cc6775b3-f249-c6dd2b1a7467","1307101848","To Whom It ..."]},{"key":"12345","values":["dcbee495-6d5e-6ed48124632c","1307103848","Hi, how are ..."]}]},{"title":"Create 5th mail","type":0,"cqs":{"create":[{"name":"messageId","value":"531ee495-6d5e-7e3a81248ef4"},{"name":"timestamp","value":"1484696746"},{"name":"email-message","value":"Hello World"}]},"table":"Mail","key":"67890"},{"title":"Get all User[67890] mails","type":2,"cqs":["messageId","timestamp","email-message"],"table":"Mail","rows":[{"key":"67890","values":["531ee495-6d5e-7e3a81248ef4","1484696746","Hello World"]}]}]
  };
  Sample.SAMPLE2 = {
    "tables":[{"name":"UserTable","rows":[{"key":"12345","cqs":[{"name":"userId","value":"12345"},{"name":"name","value":"kewang"},{"name":"slogan","value":"Happ"},{"name":"status","value":"1(login)"}]}]},{"name":"LoginTable","rows":[{"key":"kewang","cqs":[{"name":"password","value":"thisispassword"},{"name":"userId","value":"12345"}]}]},{"name":"AccessTable","rows":[{"key":"12345","cqs":[{"name":"accessToken","value":"thisisaccesstoken"},{"name":"expiredTime","value":"1455456395"}]}]}],"operations":[{"title":"Add new user information","type":0,"cqs":{"create":[{"name":"userId","value":"12345"},{"name":"name","value":"kewang"},{"name":"slogan","value":"Happ"}]},"table":"UserTable","key":"12345"},{"title":"Add id & password to login list","type":0,"cqs":{"create":[{"name":"password","value":"thisispassword"},{"name":"userId","value":"12345"}]},"table":"LoginTable","key":"kewang"},{"title":"Below is Login flow","type":3,"cqs":{}},{"title":"Check id & password is correct","type":2,"cqs":["password","userId"],"summary":"Check row key & password CQ, then get userId","table":"LoginTable","rows":[{"key":"kewang","values":["thisispassword","12345"]}]},{"title":"If id & password is correct, update Access Token","type":0,"cqs":{"create":[{"name":"accessToken","value":"thisisaccesstoken"},{"name":"expiredTime","value":"1455456395"}]},"table":"AccessTable","key":"12345"},{"title":"Update my login status","type":1,"cqs":{"create":[{"name":"status","value":"1(login)"}]},"table":"UserTable","key":"12345"},{"title":"Return my information","type":2,"cqs":["userId","name","slogan","status"],"table":"UserTable","rows":[{"key":"12345","values":["12345","kewang","Happ","1(login)"]}]},{"title":"Return access information","type":2,"cqs":["accessToken","expiredTime"],"table":"AccessTable","rows":[{"key":"12345","values":["thisisaccesstoken","1455456395"]}]},{"title":"Below is Get my information flow","type":3,"cqs":{}},{"title":"Check userId & accessToken is currect","type":2,"cqs":["accessToken","expiredTime"],"table":"AccessTable","rows":[{"key":"12345","values":["thisisaccesstoken","1455456395"]}]},{"title":"Return my information","type":2,"cqs":["userId","name","slogan","status"],"table":"UserTable","rows":[{"key":"12345","values":["12345","kewang","Happ","1(login)"]}]}]  
  };
